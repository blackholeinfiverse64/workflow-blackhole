...
import { LayoutDashboard, CheckSquare, Network, Users, Sparkles, Settings, LogOut, CheckCircle, BarChart, Airplay, LayoutDashboardIcon, Target, Monitor, DollarSign, Calendar, Clock, UserCog, Zap, Calculator, Activity, Database } from "lucide-react";
...
export function DashboardSidebar() {
  ...
  const adminRoutes = [
    ...
    { title: "EMS System", href: "/ems-dashboard", icon: DollarSign },
    { title: "Procurement Agent", href: "/procurement-dashboard", icon: UserCog },
  ];
  ...
  const userRoutes = [
    ...
    { title: "Leaderboard", href: "/leaderboard", icon: Sparkles },
    { title: "Enhanced Attendance", href: "/enhanced-attendance-tracker", icon: Activity },
  ];
