    ...
    >
      <div className="space-y-6 pb-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {/* My Tasks Stat */}
          <div className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 rounded-lg border border-gray-200 dark:border-slate-700 bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-6 pb-2">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300">My Tasks</h3>
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-slate-800 flex items-center justify-center group-hover:scale-105 transition-transform">
                <Clock className="h-5 w-5 text-gray-600 dark:text-slate-400" />
              </div>
            </div>
            <div className="p-6 pt-0">
              <div className="text-3xl font-bold text-gray-900 dark:text-slate-100">{userStats.totalTasks}</div>
          ...
          <div className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 rounded-lg border border-gray-200 dark:border-slate-700 bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-6 pb-2">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300">Completed</h3>
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-slate-800 flex items-center justify-center group-hover:scale-105 transition-transform">
                <CheckCircle className="h-5 w-5 text-gray-600 dark:text-slate-400" />
              </div>
            </div>
            <div className="p-6 pt-0">
              <div className="text-3xl font-bold text-gray-900 dark:text-slate-100">{userStats.completedTasks}</div>
          ...
          <div className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 rounded-lg border border-gray-200 dark:border-slate-700 bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-6 pb-2">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300">In Progress</h3>
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-slate-800 flex items-center justify-center group-hover:scale-105 transition-transform">
                <Clock className="h-5 w-5 text-gray-600 dark:text-slate-400" />
              </div>
            </div>
            <div className="p-6 pt-0">
              <div className="text-3xl font-bold text-gray-900 dark:text-slate-100">{userStats.inProgressTasks}</div>
          ...
          <div className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 rounded-lg border border-gray-200 dark:border-slate-700 bg-card text-card-foreground shadow-sm">
            <div className="flex flex-row items-center justify-between space-y-0 p-6 pb-2">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-slate-300">Pending</h3>
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-slate-800 flex items-center justify-center group-hover:scale-105 transition-transform">
                <AlertCircle className="h-5 w-5 text-gray-600 dark:text-slate-400" />
              </div>
            </div>
            <div className="p-6 pt-0">
              <div className="text-3xl font-bold text-gray-900 dark:text-slate-100">{userStats.pendingTasks}</div>
