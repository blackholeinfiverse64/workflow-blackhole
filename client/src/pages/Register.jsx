            ...
            {!success && (
              <>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 border-2 border-border hover:border-accent/50 bg-background/50 backdrop-blur-sm hover:bg-muted transition-all duration-300 transform hover:scale-[1.02]"
                  onClick={() => {
